...
if upload_mode == "Direct File Upload Package":
    ...
    if active_profile: st.sidebar.success(f"Linked File Account via API: {borrower_id_input}")
...
with col2:
    ...
    else: st.success("🟢 Behavioral Records Clear: No Operational Red Flags Detected")
