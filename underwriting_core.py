...
def parse_uploaded_file_stream(uploaded_file): 
    ...
    try: 
        ...
        validated_profile = { 
            ...
            "num_directors": int(float(raw_data.get("num_directors", active_row.get("num_direc", 1)))), 
...
def safe_calculate_metrics(noi, annual_ds, ca, cl, tol, tnw, req_loan, collateral): 
    ...
    # Employs annual debt obligations relative to historical net operating income
...
def map_pricing_matrix(risk_score, base_mclr, industry_classification="Pharma"): 
    ...
    # Captures High Risk sector classifications and appends a +1.50% yield premium penalty.
