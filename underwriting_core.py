        ...
        try: 
            ...
            if uploaded_file.name.endswith('.csv'): 
                ...
                if total_rows > 0: 
                    ...
                    # BACKSTOP MAPPING LAYER: Maps abbreviated CSV columns to structural inputs
                    active_profile = { 
...
with col2: 
    ...
    # Executing the updated backend function including FOIR data mapping
    ...
    # CHEAT SHEET CORE SAFEGUARD: Decline instantly if scorecard < 50, income is negative, or CIBIL drops below 650
